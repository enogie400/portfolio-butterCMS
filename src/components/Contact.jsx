            ...
            <div class="grid md:grid-cols-2">
                <div class="h-full pr-6">
                    <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                        ...
                        I'm always open to discussing new projects, and opportunities, or kindly click onmy social handles below toconnect to me.
                    ...
                    <ul class="mb-6 md:mb-0">
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">Nigeria</p>
                                <p class="text-gray-600 dark:text-slate-400">Benin City, Edo State.</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">Mobile: +234 (815) 541-7645</p>
                                <p class="text-gray-600 dark:text-slate-400">Mail: enomorogbe@gmail.com</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                            ...
                            <div class="ml-4 mb-4">
                                <h3 class="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Social Handles</h3>
                                <p class="text-gray-600 dark:text-slate-400">Linkedin Address: <a href="https://www.linkedin.com/in/enogie-omorogbe-omoros/">https://www.linkedin.com/in/enogie-omorogbe-omoros/</a></p>
                                <p class="text-gray-600 dark:text-slate-400">GitHub Respository: <a href="https://github.com/enogie400">https://github.com/enogie400</a></p>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="card h-fit max-w-6xl p-5 md:p-12" id="form">
                    ...
                    <form id="contactForm" action={"mailto:enomorogbe@gmail.com"}>
                        <div class="mb-6">
